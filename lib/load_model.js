                ...
                if (session.domOverlayState) {
                    ...
                    if (selectedObject !== null) {
                        if (selectedObject.name === "planeFront" || selectedObject.name === "planeBack") {  // if annotation is dragged
                            ...
                            selectedObject.position.lerp(parentPosition, 0.15); // smoothing

                        } else {

                            modelScene.position.add(delta);
                            modelScene.position.lerp(modelScene.position, 0.15);    // smoothing
            ...
            if (session) {
                ...
                if (!session.domOverlayState) { // for Hololens
                    ...
                    if (selectedObject !== null) {
                        ...
                        const deltaRotX = -delta.y * rotationSpeed; // 0.7 is the rotation speed - slow
                        const deltaRotY = delta.x * rotationSpeed;

                        if (selectedObject.name === "planeFront" || selectedObject.name === "planeBack") {  // if annotation is rotated
...
if (document.readyState === "complete") {
    ...
    if (isCustomAnn) {
        ...
        // append event listener to the back-to-home button
